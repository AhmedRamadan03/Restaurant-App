                ...
                <table class="table  mb-5">
                  ...
                  @if ($foods)
                      @foreach ($foods as $item)
                        ...
                        <td>
                          <a href="{{ route('foods-edit.edit',$item->id) }}" class="btn btn-info"title="edit">  <i class="fa fa-edit"></i></a>
                          <a href="{{ route('foods-destroy.destroy',$item->id) }}" class="btn btn-danger"title="delete">  <i class="fa fa-trash"></i></a>
                        </td>
                        </tr>
                      @endforeach
                  @endif
